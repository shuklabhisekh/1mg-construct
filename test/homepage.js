...
//Bhushan koli header END



// Abhishek shukla product page starts
...
data_test=[
 ...
 // Abhishek shukla product page END

//  Shyam & Pranav product page Starts
...
var data = [
  ...
  localStorage.setItem("datafy", JSON.stringify(datafy));
  
  var slice1 = datafy.slice(0, 7);
